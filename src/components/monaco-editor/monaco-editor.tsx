...
// Cosmic Dark theme with blue/purple/pink color scheme
monaco.editor.defineTheme('v1-dev-dark', {
	base: 'vs-dark',
	inherit: true,
	rules: [
		{ token: '', foreground: 'c9d1d9', background: '0a0a0f' },
		{ token: 'comment', foreground: '8b949e', fontStyle: 'italic' },
		{ token: 'keyword', foreground: 'a855f7' },
		{ token: 'number', foreground: '64b5f6' },
		{ token: 'string', foreground: '81d4fa' },
		{ token: 'type', foreground: 'ec4899' },
		{ token: 'class', foreground: 'ba68c8' },
		{ token: 'interface', foreground: '9575cd' },
		{ token: 'function', foreground: 'a855f7' },
		{ token: 'member', foreground: '64b5f6' },
		{ token: 'variable', foreground: 'c9d1d9' },
		{ token: 'constant', foreground: 'ff5722' },
		{ token: 'operator', foreground: 'ec4899' },
		{ token: 'namespace', foreground: 'ff5722' },
		{ token: 'predefined', foreground: '64b5f6' },
		{ token: 'invalid', foreground: 'ffffff', background: 'd32f2f' },
	],
	colors: {
		'editor.background': '#0a0a0f',
		'editor.foreground': '#c9d1d9',
		'editorLineNumber.foreground': '#454554',
		...
		'editor.inactiveSelectionBackground': '#64b5f622',
		'editor.lineHighlightBackground': '#1a1a2488',
		'editor.wordHighlightBackground': '#64b5f633',
