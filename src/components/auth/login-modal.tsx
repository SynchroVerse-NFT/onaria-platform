			...
			{isOpen && (
				<div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 overflow-y-auto">
					...
					>
						...
						<motion.div
							className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 blur-xl -z-10"
							animate={{
								opacity: [0.3, 0.6, 0.3],
								scale: [1, 1.05, 1],
							}}
						...
						<div className="bg-[#0f0f1a]/95 backdrop-blur-xl text-white border border-white/10 rounded-2xl shadow-2xl overflow-hidden relative">
							...
							<div className="relative p-6 pb-0 z-10">
								{showCloseButton && (
									<motion.button
										onClick={handleClose}
										className="absolute right-4 top-4 p-2 rounded-lg hover:bg-white/10 transition-colors text-white/70 hover:text-white"
								...
								<div className="text-center space-y-2">
									<motion.div
										className="mx-auto w-16 h-16 rounded-full bg-gradient-to-r from-purple-500/20 to-blue-500/20 backdrop-blur-sm border border-purple-500/30 flex items-center justify-center mb-4"
										animate={{
											boxShadow: [
							...
							{error && (
								<motion.div
									...
									className="mx-6 mt-4 p-3 rounded-lg bg-red-500/10 border border-red-500/20 flex items-start gap-2 relative z-10"
								>
							...
							<div className={clsx('p-6 space-y-5 pt-12 relative z-10')}>
								{/* GitHub */}
								{showGitHub && (
									<motion.button
										whileTap={{ scale: 0.98 }}
										...
										className="w-full group relative overflow-hidden rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 p-4 text-white hover:bg-white/10 hover:border-white/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
									>
										{/* Gradient overlay on hover */}
										<motion.div
											className="absolute inset-0 bg-gradient-to-r from-gray-500 to-gray-400 opacity-0 group-hover:opacity-10 transition-opacity"
											initial={false}
										/>
								...
								{hasEmailAuth && hasOAuth && (
									<div className="relative">
										...
										<div className="relative flex justify-center text-xs uppercase">
											<span className="bg-[#0f0f1a] px-2 text-white/40">Or continue with</span>
										</div>
									</div>
								)}
									...
									<form onSubmit={handleSubmit} className="space-y-4">
										{mode === 'register' && (
											<div>
												<input
													...
													className={clsx(
														'w-full p-3 rounded-lg border bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 transition-all outline-none',
										...
										<div className="relative">
											<input
												...
												className={clsx(
													'w-full p-3 pr-10 rounded-lg border bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 transition-all outline-none',
										...
										<motion.button
											...
											disabled={isLoading}
											className="w-full relative overflow-hidden bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 hover:shadow-lg hover:shadow-purple-500/50 text-white p-3 rounded-lg font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed group"
										>
											{/* Shimmer effect */}
											<motion.div
