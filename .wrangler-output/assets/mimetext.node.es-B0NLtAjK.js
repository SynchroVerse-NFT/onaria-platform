import { a as __esmMin, c as __toCommonJS, i as __commonJSMin, l as __toESM, o as __export, s as __require } from "./utils-DHKSaTNJ.js";
var db_exports = /* @__PURE__ */ __export({ default: () => db_default });
var db_default;
...
var require_mime_types = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function charset(type) {
		...
		var mime = match$1 && db[match$1[1].toLowerCase()];
	...
	function contentType(str) {
		...
		if (mime.indexOf("charset") === -1) {
			var charset$1 = exports.charset(mime);
			if (charset$1) mime += "; charset=" + charset$1.toLowerCase();
		}
		return mime;
	}
	...
	function populateMaps(extensions, types) {
		...
		Object.keys(db).forEach(function forEachMimeType(type) {
			...
			for (var i$1 = 0; i$1 < exts.length; i$1++) {
				var extension$1 = exts[i$1];
...
var require_global_this = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = check(typeof globalThis == "object" && globalThis) || check(typeof window == "object" && window) || check(typeof self == "object" && self) || check(typeof globalThis == "object" && globalThis) || check(typeof exports == "object" && exports) || (function() {
		return this;
...
var require_function_apply = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = typeof Reflect == "object" && Reflect.apply || (NATIVE_BIND$2 ? call$4.bind(apply$1) : function() {
...
var require_function_call = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = NATIVE_BIND$1 ? call$3.bind(call$3) : function() {
...
var require_object_property_is_enumerable = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.f = getOwnPropertyDescriptor$1 && !$propertyIsEnumerable.call({ 1: 2 }, 1) ? function propertyIsEnumerable(V) {
...
var require_get_built_in = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = function(namespace, method$1) {
		return arguments.length < 2 ? aFunction(path$2[namespace]) || aFunction(globalThis$8[namespace]) : path$2[namespace] && path$2[namespace][method$1] || globalThis$8[namespace] && globalThis$8[namespace][method$1];
	};
}));
...
var require_symbol_constructor_detection = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var $String$3 = require_global_this().String;
...
var require_shared_store = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var store$1 = module.exports = globalThis$5[SHARED] || defineGlobalProperty(SHARED, {});
...
var require_has_own_property = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = Object.hasOwn || function hasOwn$4(it, key) {
...
var require_well_known_symbol = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = function(name) {
		if (!hasOwn$3(WellKnownSymbolsStore, name)) WellKnownSymbolsStore[name] = NATIVE_SYMBOL && hasOwn$3(Symbol$1, name) ? Symbol$1[name] : createWellKnownSymbol("Symbol." + name);
...
var require_ie8_dom_define = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = !DESCRIPTORS$5 && !fails$3(function() {
...
var require_object_get_own_property_descriptor = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var $getOwnPropertyDescriptor$1 = Object.getOwnPropertyDescriptor;
	exports.f = DESCRIPTORS$4 ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor$2(O, P) {
		O = toIndexedObject(O);
		P = toPropertyKey$1(P);
...
var require_v8_prototype_define_bug = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = DESCRIPTORS$3 && fails$1(function() {
...
var require_object_define_property = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.f = DESCRIPTORS$2 ? V8_PROTOTYPE_DEFINE_BUG ? function defineProperty$1(O, P, Attributes) {
		anObject(O);
		P = toPropertyKey(P);
		anObject(Attributes);
	...
	} : $defineProperty : function defineProperty$1(O, P, Attributes) {
		anObject(O);
		P = toPropertyKey(P);
		anObject(Attributes);
...
var require_create_non_enumerable_property = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = DESCRIPTORS$1 ? function(object, key, value) {
...
var require_export = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var uncurryThis$1 = require_function_uncurry_this_clause();
	...
	var wrapConstructor = function(NativeConstructor) {
		var Wrapper = function(a$1, b, c) {
			if (this instanceof Wrapper) {
				switch (arguments.length) {
					case 0: return new NativeConstructor();
					case 1: return new NativeConstructor(a$1);
					case 2: return new NativeConstructor(a$1, b);
				}
				return new NativeConstructor(a$1, b, c);
			}
	...
	module.exports = function(options, source) {
		...
		var nativeSource = GLOBAL ? globalThis$2 : STATIC ? globalThis$2[TARGET] : globalThis$2[TARGET] && globalThis$2[TARGET].prototype;
		...
		for (key in source) {
			...
			if (options.bind && USE_NATIVE) resultProperty = bind(sourceProperty, globalThis$2);
			...
			if (PROTO) {
				...
				if (!hasOwn$1(path$1, VIRTUAL_PROTOTYPE)) createNonEnumerableProperty(path$1, VIRTUAL_PROTOTYPE, {});
...
var require_trim$6 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	require_es_string_trim();
	module.exports = require_get_built_in_prototype_method()("String", "trim");
}));
var require_trim$5 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_trim$4 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_trim$5();
}));
var require_trim$3 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_trim$4();
}));
var require_trim$2 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_trim$3();
}));
var require_trim$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_trim$2();
}));
var require_trim = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_trim$1();
}));
var import_mime_types = /* @__PURE__ */ __toESM(require_mime_types());
var import_trim = /* @__PURE__ */ __toESM(require_trim());
...
var i = class {
	...
	parse(e) {
		...
		if (this.isMailboxAddrText(e)) {
			...
			const n$1 = t.split(" <");
			return n$1[0] = /^("|')/.test(n$1[0]) ? n$1[0].slice(1) : n$1[0], n$1[0] = /("|')$/.test(n$1[0]) ? n$1[0].slice(0, -1) : n$1[0], n$1[1] = n$1[1].slice(0, -1), this.name = n$1[0], this.addr = n$1[1], this;
		}
...
var a = class {
	fields = [
		...
		},
		{
			name: "From",
			required: !0,
			validate: (e) => this.validateMailboxSingle(e),
			dump: (e) => this.dumpMailboxSingle(e)
		},
		{
			name: "Sender",
			validate: (e) => this.validateMailboxSingle(e),
		...
		{
			name: "To",
			validate: (e) => this.validateMailboxMulti(e),
			dump: (e) => this.dumpMailboxMulti(e)
		},
		{
			name: "Cc",
			validate: (e) => this.validateMailboxMulti(e),
		...
		{
			name: "Message-ID",
			generator: () => "<" + Math.random().toString(36).slice(2) + "@" + this.fields.filter(((e) => "From" === e.name))[0].value.getAddrDomain() + ">"
		},
		{
			name: "Subject",
			required: !0,
			dump: (e) => "string" == typeof e ? "=?utf-8?B?" + this.envctx.toBase64(e) + "?=" : ""
		},
		{
			name: "MIME-Version",
			generator: () => "1.0"
	...
	dump() {
		...
		for (const t of this.fields) {
			...
			const s$1 = void 0 !== t.value && null !== t.value;
			if (!s$1 && t.required) throw new n("MIMETEXT_MISSING_HEADER", `The "${t.name}" header is required.`);
			if (!s$1 && "function" != typeof t.generator) continue;
			s$1 || "function" != typeof t.generator || (t.value = t.generator());
			const i$1 = Object.hasOwn(t, "dump") && "function" == typeof t.dump ? t.dump(t.value) : "string" == typeof t.value ? t.value : "";
			e += `${t.name}: ${i$1}${this.envctx.eol}`;
		}
	...
	get(e) {
		const t = this.fields.findIndex(((t$1) => t$1.name.toLowerCase() === e.toLowerCase()));
		return -1 !== t ? this.fields[t].value : void 0;
	}
	set(e, t) {
		const s$1 = (t$1) => t$1.name.toLowerCase() === e.toLowerCase();
		if (!!this.fields.some(s$1)) {
			const i$1 = this.fields.findIndex(s$1), a$1 = this.fields[i$1];
			if (a$1.validate && !a$1.validate(t)) throw new n("MIMETEXT_INVALID_HEADER_VALUE", `The value for the header "${e}" is invalid.`);
			return this.fields[i$1].value = t, this.fields[i$1];
		}
		return this.setCustom({
			name: e,
			value: t,
			custom: !0,
			dump: (e$1) => "string" == typeof e$1 ? e$1 : ""
		});
	}
	setCustom(e) {
	...
	dumpMailboxMulti(e) {
		const t = (e$1) => 0 === e$1.name.length ? e$1.dump() : `=?utf-8?B?${this.envctx.toBase64(e$1.name)}?= <${e$1.addr}>`;
		return this.isArrayOfMailboxes(e) ? e.map(t).join(`,${this.envctx.eol} `) : e instanceof i ? t(e) : "";
	}
	dumpMailboxSingle(e) {
		return e instanceof i ? ((e$1) => 0 === e$1.name.length ? e$1.dump() : `=?utf-8?B?${this.envctx.toBase64(e$1.name)}?= <${e$1.addr}>`)(e) : "";
	}
	isHeaderField(e) {
		const t = [
			"name",
		...
		if (this.isObject(e)) {
			const s$1 = e;
			if (Object.hasOwn(s$1, "name") && "string" == typeof s$1.name && s$1.name.length > 0 && !Object.keys(s$1).some(((e$1) => !t.includes(e$1)))) return !0;
		}
		return !1;
	}
	isObject(e) {
	...
	isArrayOfMailboxes(e) {
		return this.isArray(e) && e.every(((e$1) => e$1 instanceof i));
	}
	isArray(e) {
...
var o = class {
	constructor(e, t, s$1 = {}) {
		this.envctx = e, this.headers = new r(this.envctx), this.data = t, this.setHeaders(s$1);
	}
	dump() {
...
var d = class {
	...
	asRaw() {
		const e = this.envctx.eol, t = this.headers.dump(), s$1 = this.getMessageByType("text/plain"), i$1 = this.getMessageByType("text/html"), a$1 = i$1 ?? s$1 ?? void 0;
		if (void 0 === a$1) throw new n("MIMETEXT_MISSING_BODY", "No content added to the message.");
		const r$1 = this.hasAttachments(), o$1 = this.hasInlineAttachments(), d$1 = o$1 && r$1 ? "mixed+related" : r$1 ? "mixed" : o$1 ? "related" : s$1 && i$1 ? "alternative" : "";
		if ("mixed+related" === d$1) {
			const n$1 = this.getAttachments().map(((t$1) => "--" + this.boundaries.mixed + e + t$1.dump() + e + e)).join("").slice(0, -1 * e.length), a$2 = this.getInlineAttachments().map(((t$1) => "--" + this.boundaries.related + e + t$1.dump() + e + e)).join("").slice(0, -1 * e.length);
			return t + e + "Content-Type: multipart/mixed; boundary=" + this.boundaries.mixed + e + e + "--" + this.boundaries.mixed + e + "Content-Type: multipart/related; boundary=" + this.boundaries.related + e + e + this.dumpTextContent(s$1, i$1, this.boundaries.related) + e + e + a$2 + "--" + this.boundaries.related + "--" + e + n$1 + "--" + this.boundaries.mixed + "--";
		}
		if ("mixed" === d$1) {
			const n$1 = this.getAttachments().map(((t$1) => "--" + this.boundaries.mixed + e + t$1.dump() + e + e)).join("").slice(0, -1 * e.length);
			return t + e + "Content-Type: multipart/mixed; boundary=" + this.boundaries.mixed + e + e + this.dumpTextContent(s$1, i$1, this.boundaries.mixed) + e + (s$1 && i$1 ? "" : e) + n$1 + "--" + this.boundaries.mixed + "--";
		}
		if ("related" === d$1) {
			const n$1 = this.getInlineAttachments().map(((t$1) => "--" + this.boundaries.related + e + t$1.dump() + e + e)).join("").slice(0, -1 * e.length);
			return t + e + "Content-Type: multipart/related; boundary=" + this.boundaries.related + e + e + this.dumpTextContent(s$1, i$1, this.boundaries.related) + e + e + n$1 + "--" + this.boundaries.related + "--";
		}
		return "alternative" === d$1 ? t + e + "Content-Type: multipart/alternative; boundary=" + this.boundaries.alt + e + e + this.dumpTextContent(s$1, i$1, this.boundaries.alt) + e + e + "--" + this.boundaries.alt + "--" : t + e + a$1.dump();
	}
	asEncoded() {
		return this.envctx.toBase64WebSafe(this.asRaw());
	}
	dumpTextContent(e, t, s$1) {
		const n$1 = this.envctx.eol, i$1 = t ?? e;
		let a$1 = "";
		return a$1 = e && t && (this.hasInlineAttachments() || this.hasAttachments()) ? "--" + s$1 + n$1 + "Content-Type: multipart/alternative; boundary=" + this.boundaries.alt + n$1 + n$1 + "--" + this.boundaries.alt + n$1 + e.dump() + n$1 + n$1 + "--" + this.boundaries.alt + n$1 + t.dump() + n$1 + n$1 + "--" + this.boundaries.alt + "--" : e && t ? "--" + s$1 + n$1 + e.dump() + n$1 + n$1 + "--" + s$1 + n$1 + t.dump() : "--" + s$1 + n$1 + i$1.dump(), a$1;
	}
	...
	getAttachments() {
		const e = (e$1) => e$1.isAttachment();
		return this.messages.some(e) ? this.messages.filter(e) : [];
	}
	getInlineAttachments() {
		const e = (e$1) => e$1.isInlineAttachment();
		return this.messages.some(e) ? this.messages.filter(e) : [];
	}
	getMessageByType(e) {
		const t = (t$1) => !t$1.isAttachment() && !t$1.isInlineAttachment() && (t$1.getHeader("Content-Type") || "").includes(e);
	...
	addAttachment(e) {
		...
		if (!1 === this.envctx.validateContentType(t)) throw new n("MIMETEXT_INVALID_MESSAGE_TYPE", `You specified an invalid content type "${t}".`);
		const s$1 = e.headers["Content-Transfer-Encoding"] ?? e.encoding ?? "base64";
		this.validContentTransferEncodings.includes(s$1) || (t = "application/octet-stream");
		const i$1 = e.headers["Content-ID"];
		"string" == typeof i$1 && i$1.length > 2 && !i$1.startsWith("<") && !i$1.endsWith(">") && (e.headers["Content-ID"] = "<" + e.headers["Content-ID"] + ">");
		const a$1 = e.inline ? "inline" : "attachment";
		return e.headers = Object.assign({}, e.headers, {
			"Content-Type": `${t}; name="${e.filename}"`,
			"Content-Transfer-Encoding": s$1,
			"Content-Disposition": `${a$1}; filename="${e.filename}"`
		}), this._addMessage({
			data: e.data,
			headers: e.headers
		});
	...
	addMessage(e) {
		...
		const s$1 = e.headers["Content-Transfer-Encoding"] ?? e.encoding ?? "7bit";
		this.validContentTransferEncodings.includes(s$1) || (t = "application/octet-stream");
		const i$1 = e.charset ?? "UTF-8";
		return e.headers = Object.assign({}, e.headers, {
			"Content-Type": `${t}; charset=${i$1}`,
			"Content-Transfer-Encoding": s$1
		}), this._addMessage({
			data: e.data,
			headers: e.headers
	...
	setSender(e, t = { type: "From" }) {
		const s$1 = new i(e, t);
		return this.setHeader("From", s$1), s$1;
	}
	getSender() {
		return this.getHeader("From");
	}
	setRecipients(e, t = { type: "To" }) {
		const s$1 = (this.isArray(e) ? e : [e]).map(((e$1) => new i(e$1, t)));
		return this.setHeader(t.type, s$1), s$1;
	}
...
var h = {
	...
	eol: "\n",
	validateContentType: (e) => import_mime_types.contentType(e)
};
function u() {
	return new d(h);
}
export { d as MIMEMessage, o as MIMEMessageContent, a as MIMEMessageHeader, n as MIMETextError, i as Mailbox, u as createMimeMessage };
